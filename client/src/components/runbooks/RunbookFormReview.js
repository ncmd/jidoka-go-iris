      ...
      <Grid container spacing={0}>
        ...
        <Grid item xs align="right" style={{ marginRight: '2%' }}>
          ...
          <Button
            ...
            onClick={() => submitRunbook(formValues, history)}
          >
            Submit
...
function mapStateToProps(state) {
  ...
  return {
    formValues: state.form.runbookForm.values,
  };
}

export default connect(mapStateToProps, actions)(withRouter(RunbookFormReview));
