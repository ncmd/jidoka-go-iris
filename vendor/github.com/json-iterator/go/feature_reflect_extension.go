...
<<<<<<< HEAD:vendor/github.com/json-iterator/go/reflect_extension.go
	Type   reflect2.Type
	Fields []*Binding
=======
	onePtrEmbedded     bool
	...
	Type               reflect.Type
	Fields             []*Binding
>>>>>>> parent of 3ac9317... Deployed Build:vendor/github.com/json-iterator/go/feature_reflect_extension.go
}
